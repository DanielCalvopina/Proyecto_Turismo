...
public class CreacionCliente extends javax.swing.JFrame {
    ...
    private void Aumentar_Espacios(){
        Cedula = TT_CEDULA.getText();
        Nombre = TT_NOMBRE.getText();
        Apellido = TT_APELLIDO.getText();
        Direccion = TT_DIRECCION.getText();
        ...
        if(Apellido.length()> 15){
            Apellido = Apellido.substring(0, 15);
        }
    ...
    private void REGISTRARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_REGISTRARActionPerformed
        Aumentar_Espacios();
        CLIENTES.Ingresar_Cliente(Cedula, Nombre, Apellido, Direccion, Contrasena);
